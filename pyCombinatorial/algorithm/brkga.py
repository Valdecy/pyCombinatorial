...
def elite_ls(population, distance_matrix):
    print('Preparing Elite Individual...')
...
# BRKGA Function
def biased_random_key_genetic_algorithm(distance_matrix, population_size = 250, elite = 5, bias = 0.5, mutants = 5, generations = 5000, verbose = True): 
    count      = 0
    ...
    population = elite_ls(population, distance_matrix)
